 ...
 */
export async function fetchAndFormatNessieData(accountId, apiKey, endpointPath, entityName, formatter) {
...
export function formatTransaction(transfer) {
    return {
 ...
 */
export function getFormattedPurchaseHistory(accountId, apiKey) {
 ...
 */
export function getFormattedDepositHistory(accountId, apiKey) {
    return fetchAndFormatNessieData(
        accountId,
        apiKey,
        "/deposits",
 ...
 */
export function getFormattedTransactionHistory(accountId, apiKey) {
    return fetchAndFormatNessieData(
        accountId,
        apiKey,
        "/transfers",
...
export async function getGeneralHistory(accountId) {
    
    // !!! IMPORTANT: Replace these with your actual key and account ID
    const YOUR_API_KEY = process.env.NESSIE_API_KEY;
    const ACCOUNT_TO_CHECK = accountId;
